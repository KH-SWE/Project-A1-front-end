...
export default function SignupScreen() {
  ...
  const submit = async () => {
    ...
    // TODO: call real signup API and exchange for id/token
    ...
    <View style={StyleSheet.absoluteFill} className="bg-backgroundLight">
      ...
      >
        <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', paddingTop: insets.top + 12 }}>
          <Text className="text-6xl font-inter-light">sign up</Text>
        </View>

        <View style={{ flex: 0.5 }}>
          <ScrollView contentContainerStyle={{ width: '100%', alignItems: 'center', paddingTop: 8 }} keyboardShouldPersistTaps="handled">
            <TextInput
              value={email}
        ...
        >
          ...
          <Pressable onPress={() => router.back()} className="px-6 py-5 rounded-3xl w-11/12 items-center">
